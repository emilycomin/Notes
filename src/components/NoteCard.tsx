...
export function NoteCard({ note }: NoteCardProps) {
  return (
    ...
    <Dialog.Root>
      {/* trigger é botão */}
      <Dialog.Trigger className="rounded-md text-left flex flex-col bg-slate-800 p-5 outline-none overflow-hidden relative gap-3 hover:ring-2 hover:ring-slate-600 focus-visible:ring-2 focus-visible:ring-lime-400">
      ...
      {/* portal é pra ele abrir em cima de todos o conteudo da tela */}
      <Dialog.Portal>
